    ...
    public partial class @new : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4cb8218a-f54a-472f-84db-275ff92a659f", 0, "", "5dd3e02d-9bc2-412d-a350-75538e5e52a7", new DateTime(2024, 8, 6, 21, 14, 12, 578, DateTimeKind.Local).AddTicks(8807), new DateTime(2024, 8, 6, 21, 14, 12, 578, DateTimeKind.Local).AddTicks(8790), new DateTime(2024, 8, 6, 21, 14, 12, 578, DateTimeKind.Local).AddTicks(8806), "appraiser@localhost.com", true, "Appraiser", "", "", "Appraiser", false, null, "", "APPRAISER@LOCALHOST.COM", "APPRAISER@LOCALHOST.COM", "AQAAAAIAAYagAAAAEG2LiNV4xKXwaeVueKaO+xf1ADSr8yjREwzhOQzkqDNWCGaI3HHF4wfvvggwtzamGg==", null, false, "", "cf5154d3-f0c7-45b4-9bd4-99571b2f9d99", "", false, "appraiser@localhost.com" },
                    { "588cc79d-bfba-4063-a577-a08a19ff3fba", 0, "", "35211b67-72fe-4b09-af9d-702b8c294073", new DateTime(2024, 8, 6, 21, 14, 12, 538, DateTimeKind.Local).AddTicks(1405), new DateTime(2024, 8, 6, 21, 14, 12, 538, DateTimeKind.Local).AddTicks(1393), new DateTime(2024, 8, 6, 21, 14, 12, 538, DateTimeKind.Local).AddTicks(1405), "admin@localhost.com", true, "Admin", "", "", "Admin", false, null, "", "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAED6Xi3hnEuSc330rEqip6UjIYXU5TzOip/PT3rVrsij+eguNscWGFT/z2zTiwzvbcw==", null, false, "", "b1156dce-202e-45a9-a7be-2da2d1298d94", "", false, "admin@localhost.com" },
                    { "89d67a78-bd8e-4e72-93dc-602de068282a", 0, "", "4783e288-0a26-4ee7-8f50-ffcb02004cdd", new DateTime(2024, 8, 6, 21, 14, 12, 617, DateTimeKind.Local).AddTicks(9795), new DateTime(2024, 8, 6, 21, 14, 12, 617, DateTimeKind.Local).AddTicks(9762), new DateTime(2024, 8, 6, 21, 14, 12, 617, DateTimeKind.Local).AddTicks(9794), "client@localhost.com", true, "Client", "", "", "Client", false, null, "", "CLIENT@LOCALHOST.COM", "CLIENT@LOCALHOST.COM", "AQAAAAIAAYagAAAAEP+Q0Bn1ubZpOzdVvet10pySNRjnUEW+FPdr97KzYdGbnVoIOMTbRB7Q+OjCrYBkcw==", null, false, "", "bb22ed50-1911-4a45-a84b-4097b54b67f3", "", false, "client@localhost.com" }
                });
