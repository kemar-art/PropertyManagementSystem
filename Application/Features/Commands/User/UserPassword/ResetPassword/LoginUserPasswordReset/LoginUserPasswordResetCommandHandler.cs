...
{
    public class LoginUserPasswordResetCommandHandler : IRequestHandler<LoginUserPasswordResetCommand, AppResponse>
    {
        ...
        public async Task<AppResponse> Handle(LoginUserPasswordResetCommand request, CancellationToken cancellationToken)
        {
